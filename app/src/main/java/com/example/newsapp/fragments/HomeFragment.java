...
public class HomeFragment extends Fragment implements NewsAdapter.OnArticleClickListener {
                    ...
                    public void onResponse(@NonNull Call<NewsResponse> call,
                        ...
                        if (response.isSuccessful() && response.body() != null
                            ...
                            if (articles != null && !articles.isEmpty()) {
                                ...
                                showError("No headlines available.");
                            }
                        } else {
                            showError("Failed to load headlines. Code: " + response.code());
                        }
                    }
